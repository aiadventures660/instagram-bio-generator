...
export const FontSelector: React.FC<FontSelectorProps> = ({
  ...
  return <Card className="shadow-lg border-0 bg-gradient-to-br from-white via-blue-50/20 to-indigo-50/20 dark:from-gray-800 dark:via-gray-800/50 dark:to-gray-700/50 backdrop-blur-sm">
      ...
      <CardContent className="pt-6 py-[57px]">
